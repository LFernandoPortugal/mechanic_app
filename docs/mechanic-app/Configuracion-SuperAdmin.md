...
5. Entregar la contraseña por un canal seguro y pedir al ADMIN que la cambie. La contraseña no se guarda en Firestore.
...
| `+7d / +30d` | Recalcula la expiración desde el momento actual. |
